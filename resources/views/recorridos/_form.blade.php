<div>
    ...
    <input type="text" name="titulo" value="{{ old('titulo', $recorrido->titulo ?? '') }}"
...
<div>
    ...
    <textarea name="descripcion" rows="4"
            class="w-full rounded-xl border-slate-300 focus:border-emerald-400 focus:ring-emerald-400">{{ old('descripcion', $recorrido->descripcion ?? '') }}</textarea>
</div>
